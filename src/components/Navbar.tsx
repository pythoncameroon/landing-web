  ...
  return (
    <motion.header 
      className={`sticky border-b-[1px] top-0 z-40 w-full transition-all duration-300
        ${scrolled ? "backdrop-blur-lg bg-white/80 dark:bg-background/80" : "bg-white dark:bg-background"} 
        ...
        <NavigationMenuList className="container h-16 px-4 w-screen flex justify-between items-center">
          <NavigationMenuItem className="font-bold flex">
            ...
            >
              ...
              <motion.span
                className="ml-2 bg-gradient-to-r from-primary to-purple-500 text-transparent bg-clip-text font-bold"
          ...
          <div className="flex md:hidden gap-2 items-center">
            ...
            >
              ...
              <SheetContent side={"left"} className="bg-white/95 dark:bg-background/95 backdrop-blur-lg">
                <SheetHeader>
                  <SheetTitle className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-primary animate-gradient">
                    Python Cameroon
                  </SheetTitle>
                </SheetHeader>
                  ...
                  <div className="mt-6 w-full flex flex-col items-center gap-4">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center">
                        ...
                        <span className="bg-gradient-to-r from-primary to-purple-500 text-transparent bg-clip-text font-semibold">
                          Github
                        </span>
                      </div>
                    </motion.a>
              ...
              return (
                ...
                >
                  <a
                    rel="noreferrer noopener"
                    href={route.href}
                    className={`text-[17px] relative px-4 py-2 overflow-hidden hover:bg-accent hover:text-accent-foreground rounded-md transition-colors`}
                  >
                    <span
                      className={`relative z-10 ${isActive ? "text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-500 font-medium" : ""}`}
                    >
                      {route.label}
                    </span>
                    <span 
                      className={`absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-primary to-purple-500 transition-all duration-300 ${isActive ? 'w-full' : 'w-0 group-hover:w-full'}`}
                    />
                    {isActive && (
          ...
          <div className="hidden md:flex gap-3 items-center">
            <motion.a
              ...
              href="https://github.com/pythoncameroon"
              target="_blank"
              className={`border ${buttonVariants({ variant: "secondary" })} group relative overflow-hidden`}
            >
              ...
              <div className="flex items-center justify-center relative z-10">
                ...
                <span className="bg-gradient-to-r from-primary to-purple-500 text-transparent bg-clip-text font-medium">Github</span>
              </div>
            </motion.a>
